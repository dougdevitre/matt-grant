...
export const ISSUES: Issue[] = [
  ...
  },
  {
    ...
    checklist: [
      ...
      { text: "Try the Four Fights arcade and test your strategy on the priorities.", tag: "Play", href: "/games" },
      { text: "Confirm you're registered, then vote in the August 4 primary.", tag: "Vote", href: "/vote" },
    ],
    graphic: feed("D-45"),
  ...
  },
  {
    ...
    checklist: [
      ...
      { text: "Play Cut & Save — fund tax relief by cutting waste, not gimmicks.", tag: "Play", href: "/games/cut-and-save" },
      { text: "Confirm you're registered, then vote in the August 4 primary.", tag: "Vote", href: "/vote" },
    ],
    graphic: feed("D-43"),
