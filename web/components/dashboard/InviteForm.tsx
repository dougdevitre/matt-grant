  ...
  return (
    <form action={action} className="card p-6">
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-[1fr_1.4fr_auto_auto]">
        ...
        <select name="role" defaultValue="organizer" className={field} title="Access level" aria-label="Access level">
      ...
      <p className="mt-2 text-xs text-slate">
        <strong>Organizers</strong> get field, volunteers, tasks, and graphics. <strong>Captains</strong> add precinct targets, research, the plan, and read-only finance &amp; donor totals. <strong>Admins</strong> add full finance, donors, compliance, email sends, and team management.
      </p>
      {state && (
