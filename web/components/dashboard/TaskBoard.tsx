...
export function TaskBoard({
  ...
  const { state, setState, filtered } = useTableQuery(rows, TASK_TABLE);
  ...
  return (
    <>
      <div className="mb-4">
        <DataToolbar cfg={TASK_TABLE} rows={rows} state={state} setState={setState} shown={filtered.length} />
      </div>
