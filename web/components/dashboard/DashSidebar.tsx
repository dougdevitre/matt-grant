...
const GROUPS: Group[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/voters", label: "Voter database", icon: "research", cap: "viewVoterFile" },
      { href: "/dashboard/voters/chase", label: "Ballot chase", icon: "targets", cap: "viewVoterFile" },
      { href: "/dashboard/volunteers", label: "Volunteers", icon: "volunteers", cap: "manageVolunteers" },
      { href: "/dashboard/playbook", label: "Captain playbook", icon: "tasks", cap: "manageVolunteers" },
      { href: "/dashboard/scorecard", label: "Captain scorecard", icon: "overview", cap: "manageVolunteers" },
      { href: "/dashboard/leaderboard", label: "Leaderboard", icon: "targets", cap: "manageVolunteers" },
      { href: "/dashboard/coverage", label: "Coverage map", icon: "map", cap: "manageTeam" },
      { href: "/dashboard/coverage/shifts", label: "Poll shifts", icon: "tasks", cap: "manageTeam" },
  ...
  // sees only Peace Room (no confusing "Admin" header), while staff also see Team.
  {
    items: [
      ...
      { href: "/dashboard/extension", label: "Chrome extension", icon: "campaign", cap: "viewOverview" },
