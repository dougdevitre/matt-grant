...
const STEPS = [
  {
    ...
    cta: { label: "Register / check status", href: SOS_REGISTER },
  },
  {
    n: "2",
    ...
    cta: { label: "Look up my polling place", href: SOS_LOOKUP },
  },
  {
    n: "3",
    title: "Vote early or absentee",
    body: "Can't make it on Election Day? Missouri offers in-person absentee voting in the weeks beforehand. Check the dates and rules.",
    cta: { label: "Absentee & early voting", href: SOS_GOVOTE },
  },
];
