  ...
  return (
    <>
      ...
      <p className="mb-6 max-w-prose text-sm text-slate">
        ...
        places and 3D precinct columns extruded by actual Nov-2024 turnout. Schools, public places,
        and partner anchors are sample for now. Built to drive the "show up everywhere" ground game.
      </p>
      <MapExplorer />
    </>
  );
