...
```mermaid
flowchart TD
    A["Decide to vote in the\nAug 4, 2026 primary"] --> B{"How do you want to vote?"}
    B -->|"Easiest: no excuse, no notary"| C["Option 1: Early IN PERSON\n~Jul 21 - Aug 3"]
    B -->|"Can't get there: have a reason"| D["Option 2: Absentee BY MAIL"]
    B -->|"Want a clerk to witness"| E["Option 3: Absentee IN PERSON\nat the Election Authority"]
    C --> F["Bring photo ID, vote, done"]
...
> in clearly readable type (12-point black-on-white is the FEC safe harbor for
> pieces up to 24"×36"). Have the committee treasurer confirm placement before
> distribution.
